    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 淡入淡出指示器 -->
          <div v-if="segment.fadeIn" class="fade-in" :style="{ width: getFadeWidth(segment.fadeIn, segment.duration) }"></div>
          <div v-if="segment.fadeOut" class="fade-out" :style="{ width: getFadeWidth(segment.fadeOut, segment.duration) }"></div>
        </div>
      </div>
