          ...
          <transition name="slide-fade">
            <div v-if="selectedSegment" class="timeline-operations">
              ...
              <a-button-group size="small" class="operation-group">
                <a-button type="text" @click="handleCopySegment" title="复制片段 (Ctrl+C)">
                  <template #icon><CopyOutlined /></template>
                  复制
                </a-button>
                <a-button type="text" @click="handleCutSegment" title="剪切片段 (Ctrl+X)">
                  <template #icon><ScissorOutlined /></template>
                  剪切
                </a-button>
                <a-button type="text" danger @click="handleDeleteSegment" title="删除片段 (Delete)">
              ...
              <!-- 音频处理组 -->
              <a-button-group size="small" class="operation-group">
                <a-button type="text" @click="handleSplitSegment" title="分割片段">
                  <template #icon><VerticalRightOutlined /></template>
                  分割
                </a-button>
                <a-button type="text" @click="handleFadeEffect" title="淡入淡出">
      ...
      <div class="tracks-horizontal-layout">
        ...
        >
          ...
          >
            ...
            <div
              v-if="track.segments && track.segments.length > 0"
              class="track-segments-container"
            >
              <!-- 音频片段，支持横向拖拽 -->
              <div
