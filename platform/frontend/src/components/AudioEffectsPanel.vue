    ...
    <div class="effects-content">
        ...
        <div class="effect-item">
          ...
          <div class="control-group">
            ...
            <span class="value-display"
              >{{ effects.balance > 0 ? 'R' : 'L'
              }}{{ Math.abs(Math.round(effects.balance * 100)) }}</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="effect-section">
        ...
        <div v-if="effects.equalizer.enabled" class="equalizer-controls">
          <div class="eq-bands">
            <div v-for="(band, index) in effects.equalizer.bands" :key="index" class="eq-band">
        ...
        <div v-if="effects.noiseReduction.enabled" class="noise-reduction-controls">
          <div class="effect-item">
            ...
            <div class="control-group">
              ...
              />
              <span class="value-display"
                >{{ Math.round(effects.noiseReduction.strength * 100) }}%</span
              >
            </div>
          </div>
          ...
          <div class="effect-item">
            ...
            <div class="control-group">
              ...
              />
              <span class="value-display"
                >{{ Math.round(effects.noiseReduction.threshold * 100) }}%</span
              >
            </div>
          </div>
        </div>
...
<script setup>
  ...
  // Emits
  const emit = defineEmits(['effects-changed', 'preview-effects', 'apply-effects'])
