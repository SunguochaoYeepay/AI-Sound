              ...
              <a-row :gutter="16">
                ...
                <a-col :span="8">
                  <a-form-item label="项目类型" name="type">
                    <a-select v-model:value="projectForm.type" placeholder="类型" size="large">
              ...
              <div v-if="preSelectedBook" class="pre-selected-book">
                ...
                <div class="book-preview-card">
                  <div class="book-info">
                    ...
                    <p class="book-meta">
                      作者：{{ preSelectedBook.author || '未知' }} | 字数：{{
                        (preSelectedBook.word_count || 0).toLocaleString()
                      }}
                  ...
                  <div class="book-actions">
                    <a-space>
                      ...
                      <a-button @click="showBookSelector"> 🔄 重新选择 </a-button>
                    </a-space>
                  </div>
                </div>
              </div>
              ...
              <div v-else class="manual-selection">
                ...
                <div v-else-if="availableBooks.length > 0" class="books-grid">
                  ...
                  >
                    <div class="book-item-content">
                      ...
                      <p class="book-meta">
                        {{ book.author || '未知作者' }} ·
                        {{ (book.word_count || 0).toLocaleString() }}字
                      </p>
                ...
                <div v-else-if="!booksLoading" class="no-books">
                  <a-empty description="暂无可用书籍">
                    <a-button type="primary" @click="goToCreateBook"> 📝 创建新书籍 </a-button>
                  </a-empty>
                </div>
              </div>
            </div>
            ...
            <div v-else class="selected-book">
              <div class="selected-book-card">
                <div class="selected-book-header">
                  <h3>✅ 已选择书籍</h3>
                  <a-button type="link" @click="unselectBook"> 🔄 重新选择 </a-button>
                </div>
                  ...
                  <div class="book-stats">
                    ...
                    <div class="stat-item">
                      ...
                      <span class="stat-value">{{
                        (selectedBook.word_count || 0).toLocaleString()
                      }}</span>
                    </div>
                    <div class="stat-item">
            ...
            <div v-if="canCreate" class="create-preview">
              ...
              <div class="preview-item">
                ...
                <span class="preview-value"
                  >{{ (selectedBook?.word_count || 0).toLocaleString() }} 字</span
                >
              </div>
            </div>
          </a-card>
