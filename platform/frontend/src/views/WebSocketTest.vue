    ...
    <a-card title="WebSocket连接测试" size="small">
      <template #extra>
        <a-space>
          ...
          <a-button @click="disconnectWebSocket" :disabled="!connected"> 断开连接 </a-button>
        </a-space>
      </template>
      ...
      <a-row :gutter="16">
        ...
        <a-col :span="8">
          <a-statistic title="发送消息" :value="stats.messagesSent">
            <template #prefix>
              <ArrowUpOutlined />
            </template>
          </a-statistic>
        ...
        <a-col :span="8">
          <a-statistic title="接收消息" :value="stats.messagesReceived">
            <template #prefix>
              <ArrowDownOutlined />
            </template>
          </a-statistic>
      ...
      <a-row :gutter="16">
        ...
        <a-col :span="8">
          <a-button type="primary" @click="sendTestMessage" :disabled="!connected" block>
            发送测试消息
          </a-button>
        </a-col>
      </a-row>
...
<script setup>
  ...
  import { WifiOutlined, ArrowUpOutlined, ArrowDownOutlined } from '@ant-design/icons-vue'
