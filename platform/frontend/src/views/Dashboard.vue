    ...
    <a-row :gutter="[24, 24]" style="margin-top: 24px;">
      ...
      <a-col :span="12">
        <a-card title="最近任务" :hoverable="true">
          <template #extra>
            <a-button type="link" size="small" @click="goToPage('/synthesis')">
              查看全部
            </a-button>
          </template>
      ...
      <a-col :span="12">
        <a-card title="最近书籍" :hoverable="true">
          <template #extra>
            <a-button type="link" size="small" @click="goToPage('/books')">
              查看全部
            </a-button>
          </template>
...
const recentTasks = computed(() => 
  synthesisStore.tasks.slice(0, 5)
)

const recentBooks = computed(() => 
  bookStore.books.slice(0, 5)
)
