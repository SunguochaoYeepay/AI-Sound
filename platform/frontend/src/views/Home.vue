        ...
        <a-row :gutter="[16, 16]">
            ...
            >
              <template #prefix>
                <svg
                  ...
                  height="16"
                  viewBox="0 0 24 24"
                  :fill="systemStatus.database === 'healthy' ? '#3f8600' : '#cf1322'"
                >
                  <path
          ...
          <a-col :xs="24" :sm="8">
            <a-statistic
              ...
              :value-style="{
                color: systemStatus.tts_service === 'healthy' ? '#3f8600' : '#cf1322'
              }"
            >
              <template #prefix>
                <svg
                  ...
                  height="16"
                  viewBox="0 0 24 24"
                  :fill="systemStatus.tts_service === 'healthy' ? '#3f8600' : '#cf1322'"
                >
                  <path
            ...
            >
              <template #prefix>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#3f8600">
                  <path
                    d="M12 3l1.5 4.5h4.5l-3.75 2.7 1.5 4.5L12 12l-3.75 2.7 1.5-4.5L6 7.5h4.5L12 3z"
                  />
                </svg>
              </template>
            </a-statistic>
