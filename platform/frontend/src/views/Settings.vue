                ...
                <a-row :gutter="16">
                  ...
                  <a-col :span="8">
                    <a-form-item label="自动清理周期" name="cleanupInterval">
                      <a-select v-model:value="storageSettings.cleanupInterval" size="large">
            ...
            <a-card title="系统状态" :bordered="false" class="status-card">
              ...
              <div class="status-items">
                ...
                <div class="status-item">
                  <div
                    class="status-icon"
                    :class="getStatusClass(systemStatus.ollama_service || 'unknown')"
                  >
                    <RobotOutlined />
                  </div>
                  <div class="status-content">
                    ...
                    <div class="status-value">
                      {{ getStatusText(systemStatus.ollama_service || 'unknown') }}
                    </div>
                  </div>
                </div>
              </div>
