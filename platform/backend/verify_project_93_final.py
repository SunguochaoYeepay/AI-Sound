...
def verify_project_93():
    """验证项目93的完整测试结果"""
    
    # 获取项目93详情
    url = "http://localhost:8001/api/v1/environment-generation/projects/93"
    
    try:
        response = requests.get(url)
        print(f"项目93详情API状态码: {response.status_code}")
        ...
        if response.status_code == 200:
            ...
            print(f"❌ 项目93详情API失败: {response.text}")
