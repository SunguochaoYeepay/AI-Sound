...
from app.models import (
    NovelProject, Book, BookChapter as Chapter, VoiceProfile, 
    AnalysisResult, CharacterVoiceMapping
)
...
夜深人静，大雨如注。林雨推开古宅沉重的木门，门轴发出"吱呀"的声响。
...
def create_test_project(db: Session, book: Book, voice_profiles: list):
    """创建测试项目"""
...
async def main():
    ...
    try:
        ...
        # 3. 创建项目
        print("\n🎬 创建测试项目...")
        project = create_test_project(db, book, voice_profiles)
