...
class EnvironmentDataService:
                        ...
                        for effect in sound_effects:
                            if isinstance(effect, dict):
                                sound_obj = {
                                    ...
                                    'end_time': effect.get('end_time', 0),
                                    'volume': effect.get('volume', 40),
                                    'fade_in': effect.get('fade_in', 0.2),
                                    'fade_out': effect.get('fade_out', 0.2),
    ...
    def convert_to_environment_tracks_format(environment_sounds: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for sound in environment_sounds:
            ...
            end_time = sound.get("end_time", start_time)
            duration = max(0.1, end_time - start_time) if end_time > start_time else 0.2
